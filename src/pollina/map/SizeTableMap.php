...
class SizeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'pollina.map.SizeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('size', 'Size', 'VARCHAR', false, 100, null);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('Sheet', 'Sheet', RelationMap::ONE_TO_MANY, array('id' => 'id_size', ), null, null, 'Sheets');
    } // buildRelations()
