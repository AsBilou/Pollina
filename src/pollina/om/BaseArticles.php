...
abstract class BaseArticles extends BaseObject implements Persistent
{
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ArticlesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ArticlesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArticlesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        return (string) $this->exportTo(ArticlesPeer::DEFAULT_STRING_FORMAT);
    }
