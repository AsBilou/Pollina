...
abstract class BaseConfiguration extends BaseObject implements Persistent
{
    ...
    public function setKey($v)
    {
        ...
        if ($this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[] = ConfigurationPeer::KEY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ConfigurationPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ConfigurationPeer::KEY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigurationPeer::KEY)) $criteria->add(ConfigurationPeer::KEY, $this->key);
    ...
    {
        $criteria = new Criteria(ConfigurationPeer::DATABASE_NAME);
        $criteria->add(ConfigurationPeer::KEY, $this->key);
