...
abstract class BaseConfigurationPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ConfigurationPeer::KEY, ConfigurationPeer::VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ConfigurationPeer::KEY => 0, ConfigurationPeer::VALUE => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ConfigurationPeer::KEY);
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (ConfigurationPeer::$instances as $instance)
        {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ConfigurationPeer::KEY);
            $value = $criteria->remove(ConfigurationPeer::KEY);
            if ($value) {
                $selectCriteria->add(ConfigurationPeer::KEY, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ConfigurationPeer::KEY, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ConfigurationPeer::DATABASE_NAME);
        $criteria->add(ConfigurationPeer::KEY, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ConfigurationPeer::DATABASE_NAME);
            $criteria->add(ConfigurationPeer::KEY, $pks, Criteria::IN);
